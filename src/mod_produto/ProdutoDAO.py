...
# Criar os endpoints de Produtp: GET, POST, PUT, DELETE
...
def put_produto(id: int, p: Produto):
    return {"msg": "put executado", "id": id, "nome": p.nome, "descricao": p.descricao, "foto": p.foto, "valor_unitario": p.valor_unitario}, 201
